...
public record ModMetadata : IModMetadata
{
    ...
    /// </summary>
    public string ModGuid { get; init; } = "com.sp-tushonka.examples.logging";
    ...
    /// </summary>
    public List<string>? Contributors { get; init; } = ["Contributor1", "Contributor2"];
    ...
    /// </summary>
    public List<string>? Incompatibilities { get; init; } = ["com.sp-tushonka.examples.multipleclasses"];
    ...
    public Dictionary<string, SemanticVersioning.Range>? ModDependencies { get; init; } = new()
    {
        ...
        { "com.sp-tushonka.examples.editsptconfig", new SemanticVersioning.Range("1.0.0") },

        // Compatible patch releases: 1.0.0 through <1.1.0
        { "com.sp-tushonka.examples.editdatabase", new SemanticVersioning.Range("~1.0.0") },

        // Compatible minor releases: 1.0.0 through <2.0.0
        { "com.sp-tushonka.examples.readjsonconfig", new SemanticVersioning.Range("^1.0.0") },

        // Explicit range: 1.0.0 through 2.1.0
        { "com.sp-tushonka.examples.overridemethodharmony", new SemanticVersioning.Range(">=1.0.0 <=2.1.0") },
    };
